...
// Name of WMS & WFS servers addressable only from within CTPS firewall.
CTPSUTILS.szInternalServerRoot = '/geoserver'; 
CTPSUTILS.szInternalWMSserverRoot = CTPSUTILS.szInternalServerRoot + '/wms'; 
CTPSUTILS.szInternalWFSserverRoot = CTPSUTILS.szInternalServerRoot + '/wfs';

// Name of WMS & WFS servers addressable outside of CTPS firewall.
CTPSUTILS.szExternalServerRoot = '/map';
CTPSUTILS.szExternalWMSserverRoot = CTPSUTILS.szExternalServerRoot + '/wms'; 
CTPSUTILS.szExternalWFSserverRoot = CTPSUTILS.szExternalServerRoot + '/wfs';
